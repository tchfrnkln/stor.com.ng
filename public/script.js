    ...
    var starCountRef = firebase.database().ref(`users/${x}`);
        starCountRef.on('value', (snapshot) => {
            ...
            if (!(snapData === null)) {
                ...
                nUser['store_desc'] = "Descriptions: Add press mentions, or user-generated content can be included on your description page to share how you’re impacting your customers or your industry.";
